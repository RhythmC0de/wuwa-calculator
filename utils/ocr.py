...
from utils.image_processing import prepare_for_ocr  # pylint: disable=wrong-import-position
...
if __name__ == "__main__":
    from app.main import select_image  # pylint: disable=import-outside-toplevel,no-name-in-module
